...
inquirer
  .prompt([
    ...
    },
    {
      type: 'input',
      name: 'logoColour',
      message: `Please enter a color keyword or a hexadecimal number for the logo's background colour`,
    },
    {
      type: 'list',
      name: 'logoShape',
  ...
  .catch((err) => console.error(err));const filesystem = require('./node_modules/graceful-fs/graceful-fs')
  const inquirer = require("inquirer");
